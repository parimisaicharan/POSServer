                            ...
                            if (posStagingPOJO != null) {
                                ...
                                if (Validations.isFieldNotEmpty(posStagingPOJO.getInterfaceID()) && Validations.isFieldNotEmpty(posStagingPOJO.getTransactionID())) {
                                    if (posStagingPOJO.getInterfaceID().equalsIgnoreCase("PW_IF01")) {// For Customer
                                        ...
                                        System.err.println("posStagingPOJO.getTransactionID():" + posStagingPOJO.getTransactionID());
                                        System.err.println("posStagingPOJO.getTransactionID2():" + posStagingPOJO.getTransactionID2());
                                        System.err.println("posStagingPOJO.getTransactionID3():" + posStagingPOJO.getTransactionID3());
                                        result = MasterDetails.getGiftCardSelling(con, posStagingPOJO.getTransactionID(), posStagingPOJO.getTransactionID2(), posStagingPOJO.getTransactionID3());
