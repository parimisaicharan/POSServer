 ...
 */
public class QuotationsDetailsPOJO {
    ...
    public String getRxorfsv() {
        return rxorfsv;
    }

    public void setRxorfsv(String rxorfsv) {
        this.rxorfsv = rxorfsv;
    }
